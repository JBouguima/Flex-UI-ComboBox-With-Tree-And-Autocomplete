 ...
 * 
 * @eventType offerta.autoCompleteComboBox.AutoCompleteCollectionEvent.AUTOCOMPLETE_DATAPROVIDER_FILTER_BEGIN
 * @see mx.collections.ListCollectionView#collectionChange
 * @see #autoCompleteDataProviderFiltered
 * @see #autoCompleteEnabled
 */
[Event(name="autoCompleteDataProviderFilterBegin", type="offerta.autoCompleteComboBox.AutoCompleteCollectionEvent")]
 ...
 * 
 * @eventType offerta.autoCompleteComboBox.AutoCompleteCollectionEvent.AUTOCOMPLETE_DATAPROVIDER_FILTERED
 * @see mx.collections.ListCollectionView#collectionChange
 * @see #autoCompleteDataProviderFilterBegin
 * @see #autoCompleteEnabled
 */
[Event(name="autoCompleteDataProviderFiltered", type="offerta.autoCompleteComboBox.AutoCompleteCollectionEvent")]
 ...
 * 
 * @eventType offerta.autoCompleteComboBox.AutoCompleteComboBoxResizeEvent.DROPDOWN_HEIGHT_EXPANDED
 * @see #autoCompleteEnabled
 */
[Event(name="dropdownHeightExpanded", type="offerta.autoCompleteComboBox.AutoCompleteComboBoxResizeEvent")]
 ...
 * 
 * @eventType offerta.autoCompleteComboBox.AutoCompleteComboBoxResizeEvent.DROPDOWN_WIDTH_EXPAND_BEGIN
 * @see #expandDropDownToContent
 */
[Event(name="dropdownWidthExpandBegin", type="offerta.autoCompleteComboBox.AutoCompleteComboBoxResizeEvent")]
 ...
 * @see #expandDropDownToContent
 */
[Event(name="dropdownWidthExpanded", type="offerta.autoCompleteComboBox.AutoCompleteComboBoxResizeEvent")]
 ...
 * 
 * @eventType offerta.autoCompleteComboBox.AutoCompleteComboBoxEvent.LABEL_TRUNCATED
 * @see #truncateToFit
 */
[Event(name="labelTruncated", type="offerta.autoCompleteComboBox.AutoCompleteComboBoxEvent")]
 ...
 * 
 * @eventType offerta.autoCompleteComboBox.AutoCompleteComboBoxEvent.LABEL_NOT_TRUNCATED
 * @see #truncateToFit
 */
[Event(name="labelNotTruncated", type="offerta.autoCompleteComboBox.AutoCompleteComboBoxEvent")]
 ...
 *  
 * @eventType offerta.autoCompleteComboBox.AutoCompleteComboBoxEvent.SELECTED_VALUE_NOT_FOUND
 * @see #selectedValue
 ...
 * 
 * @eventType offerta.autoCompleteComboBox.TypeAheadTimerEvent.TYPEAHEAD_RELEASETIMER_COMPLETE
 * @see #typeAheadEnabled
 */
[Event(name="typeAheadReleaseTimerComplete", type="offerta.autoCompleteComboBox.TypeAheadTimerEvent")]

/** 
 * This event is dispatched when the type-ahead timer is started.  This is caused when the user types a new character.
 * 
 * @eventType offerta.autoCompleteComboBox.TypeAheadTimerEvent.TYPEAHEAD_RELEASETIMER_START
 * @see #typeAheadEnabled
 */
[Event(name="typeAheadReleaseTimerStart", type="offerta.autoCompleteComboBox.TypeAheadTimerEvent")]
 ...
 * 
 * @eventType offerta.autoCompleteComboBox.TypeAheadTimerEvent.TYPEAHEAD_RELEASETIMER_STOP
 * @see #typeAheadEnabled
 */
[Event(name="typeAheadReleaseTimerStop", type="offerta.autoCompleteComboBox.TypeAheadTimerEvent")]
 ...
 *  
 * @eventType offerta.autoCompleteComboBox.AutoCompleteComboBoxEvent.TYPE_AHEAD_TEXT_CHANGED
 * @see #typeAheadEnabled
 * @see #AutoCompleteEnabled
 */
[Event(name="typeAheadTextChanged", type="offerta.autoCompleteComboBox.AutoCompleteComboBoxEvent")]
 ...
 * @see offerta.autoCompleteComboBox.AutoCompleteCollectionEvent
 * @see offerta.autoCompleteComboBox.AutoCompleteComboBoxEvent
 * @see offerta.autoCompleteComboBox.AutoCompleteComboBoxResizeEvent
 * @see offerta.autoCompleteComboBox.AutoCompleteListData
 * @see offerta.autoCompleteComboBox.TypeAheadTimerEvent
 */
public class AutoCompleteComboBox extends ComboBox
{
    ...
    */
    private static function classConstruct():Boolean {
        ...
        {
            StyleManager.setStyleDeclaration("autoCompleteTextInputStyleName",StyleManager.getStyleDeclaration("TextInput") , true);
        }
...
//			        var selectedValueNotChangedEvent : Event = new Event("selectedValueNotFound",false,true)
     ...
     *  @private
     */
	public function populateDataProvider():void
	{	
		var _contacts:ArrayCollection;
		var subcontacts:ArrayCollection;
		_contacts = new ArrayCollection();
		subcontacts = new ArrayCollection();
		var parts:Object;
		var partsub:Object;
		var newobj:Object;
		for(var i:int=0; i<dataProvider.length; i++){
			parts = dataProvider.getItemAt(i); 
			newobj = new Object();
			newobj.Id = parts.Id; 
			newobj.DescriptionText = parts.DescriptionText;
			_contacts.addItem(newobj);
			if(parts.children != null){
				subcontacts = parts.children;
				for(var j:int=0; j<subcontacts.length; j++){
					partsub = subcontacts.getItemAt(j); 
					newobj = new Object();
					newobj.Id = partsub.Id;
					newobj.DescriptionText = partsub.DescriptionText;
					_contacts.addItem(newobj);
				}
			}
		}
		this.dataProvider = _contacts;
    }
...
//					this.dropdown.dataProvider = this.dataProvider;
	 ...
	 * If true, the cursor will be placed at the beginning of the select string. 
	 * If false, the cursor willb e placed at the end of the select string.  
	 * 
	 *  @default true
	 */
...
//        validateNow();
        ...
        // with verdana.ttf.
        if (originalText != "" && ((textInput.textWidth + extraWidth)  > w + 0.00000000000001))
        {

            // This should get us into the ballpark.
            var s:String = textInput.text = originalText;
			s = originalText.slice(0, Math.floor((w / (textInput.textWidth + extraWidth)) * originalText.length));
